...
var _resultViewsJs = require("./views/resultViews.js");
...
async function controlRecipes() {
    try {
        ...
        await _modelJs.loadRecipe(id); //llamamos a la funcion del modelo
        (0, _recipeViewJsDefault.default).render(_modelJs.state.recipe); //ya no se necesita const {recipe} = model.state; porque se accede directamente desde model.state.recipe 
    } catch (error) {
        renderError();
    }
}
function init() {
    ...
    (0, _searchViewJsDefault.default).addHandlerSearch(controlSearchResults); // nuevo suscriptor
    (0, _paginationViewJsDefault.default).addHandlerClick(controlPagination);
}
const controlSearchResults = async function() {
    try {
        const query = (0, _searchViewJsDefault.default).getQuery(); // obtiene texto del input. Aqui se instancia la funcion searchView.getQuery
        if (!query) return; // si está vacío, se detiene
        (0, _resultViewsJsDefault.default).renderSpinner();
        await _modelJs.loadSearchResults(query); // espera resultados
        (0, _resultViewsJsDefault.default).render(_modelJs.getSearchResultsPage());
        (0, _paginationViewJsDefault.default).render(_modelJs.state.search); //renderizar botones de paginacion
    } catch (err) {
        (0, _resultViewsJsDefault.default).renderError();
    }
};
const controlPagination = function(goToPage) {
    (0, _resultViewsJsDefault.default).render(_modelJs.getSearchResultsPage(goToPage));
    (0, _paginationViewJsDefault.default).render(_modelJs.state.search);
};
init();

},{"./model.js":"3QBkH","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./views/resultViews.js":"75EUP","./views/searchView.js":"kbE4Z","./views/paginationView.js":"7NIiB","./views/recipeView.js":"3wx5k"}],"3QBkH":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./config.js":"2hPh4","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"75EUP":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class View {
   ...
   * @param {Object | Object[]} data - Los datos que se van a renderizar (p. ej. una receta)
   */ render(data) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","../../img/icons.svg":"d6UCS"}],"d6UCS":[function() {},{}],"kbE4Z":[function(require,module,exports,__globalThis) {
...
},{"url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./view.js":"2kjY2"}],"fd0vu":[function(require,module,exports,__globalThis) {
...
class recipeView {
    ...
    render(data) {
        ...
        this._data = data;
        const markup = this._generateMarkup();
        this._clear(); //instanciamos elemento clear desde el render
        this._parentElement.insertAdjacentHTML('afterbegin', markup);
    }
    _clear() {
        this._parentElement.innerHTML = '';
...
exports.default = new recipeView(); //esto crea una sola instancia (singleton) y evita que haya multiples copias de la vista,
 //por eso se usa new RecipeView() directamente al exportar

},{"url:../../img/icons.svg":"fd0vu","fraction.js":"md6n5","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"md6n5":[function(require,module,exports,__globalThis) {
/*
